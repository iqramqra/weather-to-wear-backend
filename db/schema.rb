...
ActiveRecord::Schema.define(version: 2020_03_24_060337) do
  ...
  create_table "recommendations", force: :cascade do |t|
    ...
    t.index ["weather_id"], name: "index_recommendations_on_weather_id"
  end
  ...
  add_foreign_key "recommendations", "weathers"
end
